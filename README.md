...
Бот автоматически управляет файлами для экономии места:

#### 📱 **Все пользователи:**
- ✅ **Файлы удаляются** с диска после каждого использования для экономии места
...
- 🔍 **Поиск музыки** - по названию или ссылке
- 💾 **Автоматическое скачивание** треков с YouTube
- 🎵 **Хранение музыки** в личной коллекции
- 🧹 **Автоматическая очистка** MP3 файлов
- 🌐 **Готов к развертыванию** на Render
...
3. **Настройте бота:**
   ...
   - Проверьте настройки в `env_template.txt`
...
- **📱 Все пользователи:** Список треков остается, но файлы удаляются после использования для экономии места

**Q: Нужно ли искать треки заново?**
- **📱 Все пользователи:** Да, при "Скачать все" треки заново качаются с YouTube
